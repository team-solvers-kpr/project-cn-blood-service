      ...
      <div class="">
        <div class="flex  justify-center">
          <div class="flex flex-none lg:w-96 lg:mx-24 ml-12">
            <div class="">
              <div>
                <img src={image0} alt="" className="lg:h-16 lg:w-96" />
              </div>
              <div>
              ...
              <div class=" flex my-6 ">
                ...
                <FaTiktok class="hover:text-red-600 text-gray-400 text-3xl mx-1 mt-1">
                  {" "}
                </FaTiktok>
              </div>
          ...
          <div class="lg:flex grow justify-between hidden">
            <div class="m-4 mr-12 w-1/4">
              ...
              <h5 className="text-justify  mt-2 whitespace-normal">
                <a
                  ...
                  rel="noopener noreferrer"
                >
                  Sign language <br></br> interpreting services for Deaf,
                  deafened and hard of hearing donors
                </a>
              </h5>
              <h5 className="text-justify  mt-2 whitespace-normal">
                <a
