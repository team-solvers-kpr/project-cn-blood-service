  ...
  return (
    <div>
      <form action="" className=' max-w-md transition-all duration-100 ease-in-out '>
        ...
        autoComplete='off'
        aria-label='Search what you want to search'
        className=' h-[50px] pr-16 pl-16 w-[500px] py-2 font-semibold placeholder:italic placeholder-gray-500 text-gray-500 rounded-full border-none ring-2 ring-gray-300 focus:ring-gray-500 focus:ring-2'
         />
         <label
