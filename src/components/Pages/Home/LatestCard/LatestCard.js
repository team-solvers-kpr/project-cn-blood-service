...
const LatestCard = () => {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2  lg:grid-cols-3 lg:gap-4 md:gap-4 max-w-full items-center">
      {latestCardData &&
        latestCardData.map((data) => (
          <div>
            <div
              className="bg-white flex flex-col shadow-lg items-center h-[720px]"
              key={data.id}
            >
