      ...
      <div className=" lg:w-full " style={{ backgroundColor: "#E7131A" }}>
        <div className="lg:py-32 lg:px-40 p-4">
          ...
          <p className="text-white text-lg font-normal mb-6 text-justify">
            The greatest human connection is made when we give to each other.
            Whether it’s time, knowledge, expertise, or a lifesaving donation.
            These connections are what make us Canada’s Lifeline.
          </p>
          <p className="text-white text-lg font-normal text-justify">
            Join us. You won’t just make a difference, you’ll make all the
            difference.
          </p>
        </div>
      </div>
