...
const WhatWeDoMatters = () => {
  return (
    <div className="lg:flex">
      <div className=" lg:relative hidden lg:block lg:ml-48 ">
            <img src={bgImage} alt="" className="lg:ml-96 lg:h-96"/>
        </div>
        <div className=" lg:absolute  p-4 lg:mx-32 lg:mt-8">
        
            <h1 className="lg:text-6xl text-5xl font-bold text-justify mb-4 text-stone-600">What we do matters</h1>
           <p className="text-stone-600">Somewhere in Canada there’s a life you can save. Join <strong>Canada’s Lifeline</strong> today.</p>
            <div className="">
