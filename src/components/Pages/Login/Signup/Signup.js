         ...
         <div className="text-start bg-white my-8 lg:mr-8 ml-5 lg:ml-0 mr-5 rounded-md">
            <div className="px-5 py-10">
               ...
               <h2 className="my-4 text-lg">
                  Complete the form below to create an account. Once you've
                  completed the required information, proceed to the next step.
               </h2>
                  ...
                  <div className="mt-3 ml-1">
                     ...
                     >
                        ...
                        >
                           ...
                           <div className="ml-2">
                              Minimum 8 characters, At least one capital letter,
                              At least one lower case letter, At least one
                              number, No spaces.
                           </div>
                        </div>
