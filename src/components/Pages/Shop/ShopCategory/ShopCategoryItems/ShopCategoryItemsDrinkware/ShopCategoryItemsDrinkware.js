...
const ShopCategoryItemsDrinkware = () => {
    ...
    return (
        <>
            <div className='md:container md:mx-auto '>
                <h3 className='allProductsTitle'>Drinkware</h3>
                <div className='grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 justify-items-center'>
                    {
                        products.filter(category => category.category === "drinkware").map(product => <div key={product.code} className="mb-20 mt-12">
...
export default ShopCategoryItemsDrinkware;