  ...
  <div class="accordion-item  bg-white">
    ...
    <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree"
      ...
      <div className="bg-white lg:p-16 p-6">
            ...
            <p className="lg:text-lg text-base  text-justify mb-4 text-gray-600">Both documents were aimed at providing direction for the future. They established key principles for the blood system, including these examples:</p>
            <ul className="lg:text-lg text-base  text-justify mb-4 text-gray-600 p-6">
                <li className="mb-2">Safety of the blood supply is paramount.</li>
                <li className="mb-2">Blood is a public resource.</li>
                <li className="mb-2">Donors of blood and plasma should not be paid, except in rare circumstances.</li>
                <li className="mb-2">Adequacy and security of supply of all needed blood components and plasma fractions for Canadians should be encouraged.</li>
                <li className="mb-2">Sufficient blood should be collected so that importation from other countries is unnecessary.</li>
                <li className="mb-2">Access to blood products, including fractionated plasma products, should be free and universal.</li>
                <li className="mb-2">A national blood supply program should be maintained.</li>
            </ul>
            <p className="lg:text-lg text-base  text-justify mb-4 text-gray-600">These documents, and the principles they contain, have provided essential guidance for Canadian Blood Services.</p>
        </div>
      </div>
    </div>
  </div>
