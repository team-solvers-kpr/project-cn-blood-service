...
const LastRedPart = () => {
  return (
    <div className="mb-4  lg:px-16 py-6 " style={{backgroundColor:'#C4161C'}}>
      <div className="lg:flex lg:p-10 p-4">
     <div className="lg:px-16">
     <h1 className="text-3xl font-bold text-justify lg:mb-10 mb-6 text-gray-100">Our governance</h1>
      ...
      <div className="flex">
      <p className="hover:text-gray-300 hover:cursor-pointer lg:text-lg text-base  text-justify lg:mb-4 text-gray-100">Executives and Board of Directors</p>
      <p className="hover:text-gray-300 hover:cursor-pointer text-base mt-2 ml-1 lg:mb-4 text-gray-100"><FaArrowRight></FaArrowRight></p>
      </div>
      <div className="flex">
      <p className="hover:text-gray-300 hover:cursor-pointer lg:text-lg text-base  text-justify mb-4 text-gray-100">Board Meetings</p>
