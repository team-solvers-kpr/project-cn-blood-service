...
const MiddlePartOne = () => {
 ...
 {/* right side  */}
    <div className="bg-gray-100 w-1/2 py-12">
    <h1 className=" pl-28 hover:text-red-800 text-3xl font-bold cursor-pointer hover:no-underline text-red-700 text-justify"><a href="https://www.blood.ca/en/research/our-research-activities"> Products and Services for Researchers</a></h1>
    <p className="px-28 text-justify mt-10 text-base text-gray-600">
    Discover more about products and services offered by Canadian Blood Services:
    </p>
    <div className="flex mt-6 px-28">
