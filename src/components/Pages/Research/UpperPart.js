    ...
    <div className="lg:flex overflow-hidden ">
      ...
      <div className="xl:ml-32 lg:absolute lg:w-4/5 xl:w-1/2 mt-10 p-3">
        ...
        <p className="text-justify text-base text-gray-600 mb-6 lg:w-4/5">
          ...
          collaboration with an extended network of partners, our team fosters
          discovery and clinical research, conducts product and process
          development research, translates knowledge through leading practices,
          and builds capacity through training and education.
        </p>
        <div>
          <div class=" text-justify mb-1">
            <p className="text-gray-600 text-base text-justify ">
              ...
              to receive <br></br> monthly updates on our research and education
              activities.
            </p>
          </div>
          <div class=" text-justify mt-4">
            <p className="text-gray-600 text-base text-justify ">
              ...
              or learn more <br></br> about research at Canadian Blood Services
              below.
            </p>
          </div>
        </div>
        ...
        <div className="2xl:mb-32">
          <div className="flex mt-4">
            <div className="mt-2 mr-4">
              {" "}
              <FaArrowRight className="text-cyan-400 text-sm "></FaArrowRight>
            </div>
            <div className=" ">
              {" "}
              <p className="hover:text-red-800 cursor-pointer text-red-600 text-justify text-base  mt-1">
                <a
                  href="https://www.blood.ca/en/research/our-research-activities"
                  target="_blank"
                  rel="noopener noreferrer"
                >
          ...
          <div className="flex">
            ...
            <div className=" ">
              ...
              <p className="hover:text-red-800 cursor-pointer text-red-600 text-justify text-base  mt-1">
                <a
                  href="https://www.blood.ca/en/research/our-research-stories"
                  target="_blank"
                  rel="noopener noreferrer"
                >
          ...
          <div className="flex">
            ...
            <div className=" ">
              ...
              <p className="hover:text-red-800 cursor-pointer text-red-600 text-justify text-base  mt-1">
                <a
                  href="https://www.blood.ca/en/research/our-research-funding-opportunities"
                  target="_blank"
                  rel="noopener noreferrer"
                >
          ...
          <div className="flex">
            ...
            <div className=" ">
              ...
              <p className="hover:text-red-800 cursor-pointer text-red-600 text-justify text-base  mt-1">
                <a
                  href="https://www.blood.ca/en/research/products-and-services-researchers"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  Products and Services for Researchers
                </a>{" "}
              </p>
            </div>
          </div>
          <div className="flex">
            ...
            <div className=" ">
              ...
              <p className="hover:text-red-800 cursor-pointer text-red-600 text-justify text-base  mt-1">
                <a
                  href="https://www.blood.ca/en/research/contract-research-and-technology-transfer"
                  target="_blank"
                  rel="noopener noreferrer"
                >
          ...
          <div className="flex">
            ...
            <div className=" ">
              ...
              <p className="hover:text-red-800 cursor-pointer text-red-600 text-justify text-base  mt-1">
                <a
                  href="https://www.blood.ca/en/research/leading-practices-and-educational-resources"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  Leading Practices and Educational Resources{" "}
                </a>{" "}
              </p>
            </div>
          </div>
          <div className="flex">
            ...
            <div className=" ">
              ...
              <p className="hover:text-red-800 cursor-pointer text-red-600 text-justify text-base  mt-1">
                <a
                  href="https://www.blood.ca/en/research/research-dissemination-resources"
                  target="_blank"
                  rel="noopener noreferrer"
                >
